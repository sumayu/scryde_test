  ...
  mystics: [
    {
      ...
      paths: [
        { 
          ...
          secondPaths: [
            { third: "СОРКЕР (Sorceror)", thirdIcon: "/sorcerer_ss.png", fourth: "АРХИМАГ (Archmage)", fourthIcon: "/archmage.png" },
...
export const CLASS_STATS: Record<string, { solo: number, pve: number, pvp: number, support: number, surv: number, control: number }> = {
  ...
  "Sorceror": { solo: 70, pve: 75, pvp: 80, support: 10, surv: 40, control: 50 },
